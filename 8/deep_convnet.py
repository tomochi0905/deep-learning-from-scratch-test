...
class DeepConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28),
        ...
        pre_node_nums = np.array([1 * 3 * 3, 16 * 3 * 3, 16 * 3 * 3, 32 * 3 * 3, 32 * 3 * 3, 64 * 3 * 3, 16 * 4 * 4, hidden_size])
        weight_init_scales = np.sqrt(2.0 / pre_node_nums) # Relu を使う場合に推奨される初期値（He の初期値）
    ...
    def gradient(self, x, t):
        ...
        # 設定
        grads = {}
        for i, layer_idx in enumerate((0, 2, 5, 7, 10, 12, 15, 18)): # この数字はどうやら Convolution と Affine を指しているらしい
